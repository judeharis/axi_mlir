...
func @matmul_call(%A: memref<60x80xf32>, %B: memref<80x72xf32>, %C: memref<60x72xf32>) {
...
func @main() {
  ...
  %A_typed = memref.cast %A: memref<?x?xf32> to memref<60x80xf32>
  %B_typed = memref.cast %B: memref<?x?xf32> to memref<80x72xf32>
  %C_typed = memref.cast %C: memref<?x?xf32> to memref<60x72xf32>
  %Ctmp_typed = memref.cast %Ctmp: memref<?x?xf32> to memref<60x72xf32>
  
  %in1 = memref.cast %A_typed: memref<60x80xf32> to memref<*xf32>
  %in2 = memref.cast %B_typed: memref<80x72xf32> to memref<*xf32>
  %out1 = memref.cast %C_typed: memref<60x72xf32> to memref<*xf32>
  %outtmp = memref.cast %Ctmp_typed: memref<60x72xf32> to memref<*xf32>

  call @print_memref_f32(%in1) : (memref<*xf32>) -> ()
  call @print_memref_f32(%in2) : (memref<*xf32>) -> ()

  call @matmul_call(%A_typed, %B_typed, %C_typed) : (memref<60x80xf32>, memref<80x72xf32>, memref<60x72xf32>) ->()
