...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/home/axi4mlir/tester1/experiments/ex1_pynq/libs/:/home/axi4mlir/tester1/experiments/ex1_pynq/bins/
...
# load this via generated source
# Used by both MLIR MATMUL library and final app

source ./bins/appslist.sh

# run CPU if strategy contains CPU
# ===========================
if [[ " ${StrategyArray[@]} " =~ " CPU " ]]; then
