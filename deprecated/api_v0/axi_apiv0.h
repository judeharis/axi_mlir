...
struct dma_collection{
     ...
     */
    void dma_init(int dma_count, unsigned int* dma_address, unsigned int* dma_input_addr,  unsigned int* dma_input_len,  unsigned int* dma_output_addr,  unsigned int* dma_output_len);
